...
`tiled_flood_fill` 工具，因此 registry 仍为 18 core / 19 with rasterizer。它只接受
...
`tiled_copy_region` standalone tool，因此 registry 仍为 18 core / 19 with rasterizer。
